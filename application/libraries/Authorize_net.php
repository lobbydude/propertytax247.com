...
class Authorize_net
{
    ...
    private $api_login_id = '3N5s3JyJr';			// API Login ID
    private $api_transaction_key = '86577phtVXGL8st6';	// API Transaction Key
	...
	public function debug()
	{
		...
		//echo "<h3>Response</h3>\n";
		//echo "<code>" . print_r(nl2br(htmlentities($this->response))) . "</code><br/>\n\n";
		//echo "<hr>\n";
